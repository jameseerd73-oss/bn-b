    local Library = {}; do
        Library = {
            ...
            FolderName = "reaperhookeabetabuild";
        ...
        do
            ...
            if not isfile(Library.FolderName .. '/Utilities/Saturation.png') then
                writefile(Library.FolderName .. '/Utilities/Saturation.png', game:HttpGet("https://www.freeiconspng.com/uploads/white-snowflake-png-2.png"));
            end;
    
            if not isfile(Library.FolderName .. '/Utilities/Value.png') then
                writefile(Library.FolderName .. '/Utilities/Value.png', game:HttpGet("https://www.freeiconspng.com/uploads/white-snowflake-png-2.png"));
            end;
    
            if not isfile(Library.FolderName .. '/Utilities/Logo.png') then
                writefile(Library.FolderName .. '/Utilities/Logo.png', game:HttpGet("https://www.freeiconspng.com/uploads/white-snowflake-png-2.png"));
            end;
        end;
